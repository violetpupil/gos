...
func (c *userClient) GetUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedUserServer) GetUser(context.Context, *IdRequest) (*Response, error) {
